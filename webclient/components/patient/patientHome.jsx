                ...
                <Dimmer active={activate1} page>
                  ...
                  <Card style={{
                    ...
                    {this.state.item.Status != 'Unassigned' && this.state.item.AssignedPhelbo != undefined && this.state.item.Status != 'Cancelled'
                      ? <div>
                        <table style={{width:'100%',color:'teal',fontSize:'110%'}}>
                        <tr><td style={{padding:'3%',textAlign:'left'}}>Phlebo Id </td><td style={{textAlign:'left'}}>{this.state.item.AssignedPhelbo.ID}</td></tr>
                        <tr><td style={{padding:'3%',textAlign:'left'}}>Phlebo Name </td><td style={{textAlign:'left'}}>{this.state.item.AssignedPhelbo.Name}</td></tr>
                        </table>
                        </div>
                      : null}
                    {this.state.item.Status != undefined && this.state.item.Status == 'Completed' && this.state.item.FeedbackStatus != 'Filled'
                      ...
                      <div>
                        <table style={{width:'100%',color:'teal',fontSize:'110%'}}>
                        <tr><td style={{padding:'3%',textAlign:'left'}}>Feedback</td><td style={{textAlign:'left'}}><button type="button" className="btn btn-link" style={{
                          color: 'orange'
